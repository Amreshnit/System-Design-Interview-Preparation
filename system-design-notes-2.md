...
Whether you're preparing for an interview or you want to design a distributed/microservice-oriented application, this list will help you achieve that.

Attention: Stars on GitHub do not reflect usage or popularity for every item here listed.
